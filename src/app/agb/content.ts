...
export const agb: Paragraph[] = [
  ...
  },
  {
    ...
    plain: [
      ...
      "Entgangene Gewinne, Datenverluste oder Folgeschäden sind bei kleinen Versehen nicht dabei. Wenn ich Ihre Webseite hoste oder einen Wartungsvertrag mit Ihnen habe, kümmere ich mich um regelmäßige Backups nach einem festen Konzept (tägliche Sicherungen, mehrere Aufbewahrungsstufen, ausgelagert bei einem zweiten Anbieter). Hosten Sie selbst oder haben Sie keinen Wartungsvertrag, sind Sie für Backups verantwortlich — ich zeige Ihnen gerne, wie das praktisch geht.",
