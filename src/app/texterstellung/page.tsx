...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Texterstellung" },
  ],
};
...
const offerCatalogSchema = {
  "@context": "https://schema.org",
  "@type": "OfferCatalog",
  name: "Texterstellung für Webseiten — Pakete von Michael Höger",
  url: `${siteUrl}/texterstellung/`,
  itemListElement: pakete.map((p, i) => ({
    ...
    seller: { "@type": "Person", name: "Michael Höger", url: siteUrl },
    itemOffered: {
      "@type": "Service",
      name: `Texterstellung Paket ${p.name}`,
      description: p.claim,
      provider: { "@type": "Person", name: "Michael Höger", url: siteUrl },
      areaServed: { "@type": "Country", name: "DE" },
      serviceType: "Werbetexter / Webtexte",
    },
  })),
};
